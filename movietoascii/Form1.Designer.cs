namespace movietoascii
{
    partial class ASCIIConverter
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btAsciiCharacters.Click += new System.EventHandler(this.SetAsciiCharacters);
			// 
			// btUpdateCharacters
			// 
			...
			this.cbHQ.Checked = true;
			this.cbHQ.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbHQ.Location = new System.Drawing.Point(324, 871);
			this.cbHQ.Name = "cbHQ";
			this.cbHQ.Size = new System.Drawing.Size(42, 17);
			this.cbHQ.TabIndex = 12;
			this.cbHQ.Text = "HQ";
			this.cbHQ.UseVisualStyleBackColor = true;
			this.cbHQ.CheckedChanged += new System.EventHandler(this.cbHQ_Checked_Changed);
			// 
			// ASCIIConverter
			// 
